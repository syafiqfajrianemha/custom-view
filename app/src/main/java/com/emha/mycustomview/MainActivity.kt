...
import com.emha.mycustomview.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setMyButtonEnable() {
        ...
        binding.myButton.isEnabled = result != null && result.toString().trim().isNotEmpty()
    }
}